...
export async function GET(
  ...
  try {
    ...
    // Actual cost from campaign_recipients
    const { data: actualCostRows } = await supabase
      .from("campaign_recipients")
      .select("actual_price")
      .eq("campaign_id", id)
    ...
    // Opt-outs generated by this campaign (contacts who opted out after receiving)
